...
BRNN::BRNN(int the_NU, int the_NY, int the_NH, int the_context, int the_Moore, int the_NF, int the_NB, int the_NH2, int the_CoF, int the_CoB, int the_Step, int the_shortcut, int the_doubleo) :
...
void
BRNN::F1_F(double *seq, int t, int length) {
...
void
BRNN::F1_F(int *seq, int t, int length) {
...
void
BRNN::B1_B(double* seq, int t, int length) {
...
void
BRNN::B1_B(int* seq, int t, int length) {
...
void
BRNN::propagate(double* seq, int length) {
int T=length;
int t,f,b;
...
void
BRNN::propagate(int* seq, int length) {
int T=length;
int t,f,b;
...
void
BRNN::forward(double* seq, int t, int length) {
int f,b,v,c;
double I[8196];
...
void
BRNN::forward(int* seq, int t, int length) {
int f,b,v,c;
int I[8196];
...
void
BRNN::forward(double* seq, int t1, int t2, int length) {
int f,b,v,c;
double I[8196];
...
void
BRNN::forward(int* seq, int t1, int t2, int length) {
int f,b,v,c;
int I[8196];
...
void
BRNN::forward_backward(double* seq, int t, int length, double* target, int backp) {
int f,b,v,c;
double I[8196];
...
void
BRNN::forward_backward(int* seq, int t, int length, double* target, int backp) {
int f,b,v,c;
int I[8196];
...
void
BRNN::forward_backward(double* seq, int t1, int t2, int length, double** target, int backp) {
int f,b,v,c;
double I[8196];
...
void
BRNN::forward_backward(int* seq, int t1, int t2, int length, double** target, int backp) {
int f,b,v,c;
int I[8196];
...
void
BRNN::F1_Fbp(double *seq, int t, int length, int backp) {
double I[8196];
int f,s,c;
...
void
BRNN::F1_Fbp(int *seq, int t, int length, int backp) {
int I[8196];
int f,s,c;
...
void
BRNN::B1_Bbp(double* seq, int t, int length, int backp) {
double I[8196];
int b,s,c;
...
void
BRNN::B1_Bbp(int* seq, int t, int length, int backp) {
int I[8196];
int b,s,c;
...
void
BRNN::back_propagate(double* seq, int length, int backp) {
int T=length;
int t;
...
void
BRNN::back_propagate(int* seq, int length, int backp) {
int T=length;
int t;
...
void
BRNN::extimation(double *seq, int* y, int length, int backp) {
...
void
BRNN::extimation(int *seq, int* y, int length, int backp) {
...
void
BRNN::extimation(double *seq, double* y, int length, int backp) {
...
void
BRNN::extimation(int *seq, double* y, int length, int backp) {
...
void
BRNN::Feed(double* seq, int length) {
int t;
...
void
BRNN::predict(double* seq, int length) {

Feed(seq,length);
}

void
BRNN::predict(int* seq, int length) {
